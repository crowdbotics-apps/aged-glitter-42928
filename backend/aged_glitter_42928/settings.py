"""
Django settings for aged_glitter_42928 project.
...
ROOT_URLCONF = 'aged_glitter_42928.urls'
...
WSGI_APPLICATION = 'aged_glitter_42928.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_glitter_42928 API",
    "DESCRIPTION": "API documentation for aged_glitter_42928 App",
    "VERSION": "v1",
}
